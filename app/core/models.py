...
print('dnjdhhdjdhjdgjgdjhdjdhddd')
class Coin(models.Model):
    ...
    number_of_available_token = models.DecimalField(
...
class Bid(models.Model):
    ...
    number_of_tokens = models.DecimalField(max_digits=10, decimal_places=5)
    bidding_price = models.PositiveIntegerField()
    token_recieved = models.DecimalField(
